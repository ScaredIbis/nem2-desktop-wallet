              ...
              <div class="list_container radius scroll">
                ...
                <div class="list_body scroll">
                  ...
                  <div
                    ...
                    v-for="(i, index) in cosignatoryModifications.modifications"
                    :key="index"
                  >
                    <span class="address_alias">{{i.cosignatory.publicKey}}</span>
                    <span
                      class="action"
                    >{{ i.addOrRemove === AddOrRemove.ADD ? $t('add') : $t('Remove') }}</span>
                    <img
